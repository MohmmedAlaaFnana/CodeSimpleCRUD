...
namespace CodeSimpleCRUD.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Name,Descrption,Category,Cost,Pric")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Name,Descrption,Category,Cost,Pric")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
